        ...
        if (request != null) {
            ...
            try {
                ...
                while (parameterNames.hasMoreElements()) {
                    ...
                    if (custom_search && StringUtils.startsWith(param_name, "s-")) {
                                ...
                                if (param_array != null && param_array.length >= 2) {
                                    ...
                                    switch (query_condition) {
                                        case BETWEEN:
                                            ...
                                            break;
                                        case LIKE:
                                            _params.add(Triplet.<String, Condition, Object>with(name, query_condition, DaoKit.like(req_val)));
                                            break;
                                        case LLIKE:
                                            _params.add(Triplet.<String, Condition, Object>with(name, query_condition, DaoKit.llike(req_val)));
                                            break;
                                        case RLIKE:
                                            _params.add(Triplet.<String, Condition, Object>with(name, query_condition, DaoKit.rlike(req_val)));
                                            break;
                                        default:

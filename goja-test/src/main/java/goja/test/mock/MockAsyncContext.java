...
import goja.kits.reflect.Beans;
...
public class MockAsyncContext implements AsyncContext {
    ...
    public void complete() {
        MockHttpServletRequest mockRequest = getNativeRequest(request, MockHttpServletRequest.class);
        if (mockRequest != null) {
    ...
    public <T extends AsyncListener> T createListener(Class<T> clazz) throws ServletException {
        return Beans.instantiateClass(clazz);
    }

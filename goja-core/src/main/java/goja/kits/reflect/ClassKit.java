...
import goja.kits.collection.CollectionKit;
...
public class ClassKit {
    ...
    public static String getShortNameAsProperty(Class<?> clazz) {
        String shortName = ClassKit.getShortName(clazz);
    ...
    private static String getQualifiedNameForArray(Class<?> clazz) {
        ...
        while (clazz.isArray()) {
            ...
            result.append(ClassKit.ARRAY_SUFFIX);
        }
            ...
            try {
                if (Modifier.isPublic(method.getModifiers())) {
                    ...
                    Method specificMethod =
                            ReflectionKit.findMethod(targetClass, method.getName(), method.getParameterTypes());
